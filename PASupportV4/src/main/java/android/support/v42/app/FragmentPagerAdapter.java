...
import android.support.v42.app.FragmentStatePagerAdapter;
...
/**
 * Implementation of {@link android.support.v42.view.PagerAdapter} that
...
public abstract class FragmentPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        String name = makeFragmentName(container.getId(), itemId, mId);
        ...
        if (fragment != null) {
            ...
            mCurTransaction.add(container.getId(), fragment,
                    makeFragmentName(container.getId(), itemId, mId));
        }
    ...
    public static String makeFragmentName(int viewId, long id, String mId) {
        return "android:switcher:" + viewId + ":" + id + ":" + mId;
    }
}
