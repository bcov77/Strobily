...
package android.support.v42.app;
...
import android.support.v42.util.LogWriter;
 ...
 */
public final class BackStackRecord extends FragmentTransaction implements
    ...
    public boolean wasRemoved(Fragment frag) {
    	...
    	while (op != null) {
    		...
    		if (op.removed != null && op.removed.size() > 0) {
    			...
    			for (int iii = 0; iii < size; iii++) {
    				if (op.removed.get(iii) != null && op.removed.get(iii).equals(frag))
    					return true;
    			}
    		}
    		op = op.prev;
    ...
    public boolean isInTail(Fragment frag) {
    ...
    public boolean isInHead(Fragment frag) {
    ...
    public void popFromBackStack(boolean doStateMove, boolean showNew) {
    	 if (FragmentManagerImpl.DEBUG) {
    ...
    public void popFromBackStack(boolean doStateMove) {
       popFromBackStack(doStateMove, true);
    }
