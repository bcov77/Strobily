...
package android.support.v42.internal.view;

import android.support.v42.view.ActionProvider;
import android.support.v42.view.MenuItemCompat;
...
public interface SupportMenuItem extends android.view.MenuItem {
    ...
    */
     ...
     * provider set via {@link #setSupportActionProvider(android.support.v42.view.ActionProvider)}. </p>
     *
    ...
    /**
     * Sets the {@link android.support.v42.view.ActionProvider} responsible for creating an action view if
     ...
     * @return This Item so additional setters can be called.
     * @see android.support.v42.view.ActionProvider
     */
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(android.support.v42.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link android.support.v42.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionExpand(MenuItem)} method
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(android.support.v42.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link android.support.v42.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionCollapse(MenuItem)} method
     ...
     * @see android.support.v42.view.MenuItemCompat.OnActionExpandListener
     */
    public boolean isActionViewExpanded();

    /**
     * Set an {@link android.support.v42.view.MenuItemCompat.OnActionExpandListener} on this menu item to be notified when the associated
